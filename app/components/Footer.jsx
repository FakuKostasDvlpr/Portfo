...
export default function Footer() {
    ...
    return (
        ...
        <footer id="contact" className="reveal-bottom FooterLast rounded-xl mx-auto bg-white  h-[500px] w-full max-w-[380px] md:max-w-[920px] items-center justify-center ">
            <div className="text-4xl pt-6 mx-4 font-medium">
                <h3>Want to work  <span className="text-[#e3c448] font-medium">together?</span></h3>
            </div>
            <div className="gap-6 mb-10 flex mt-6 flex-col justify-center items-center text-center">
                <form onSubmit={handleSubmit} ref={form} className="space-y-4 gap-x-4 mb-12 flex flex-col items-center justify-center" id="contact" action="mailto:facucostas07@gmail.com" method="post">
                    <input 
